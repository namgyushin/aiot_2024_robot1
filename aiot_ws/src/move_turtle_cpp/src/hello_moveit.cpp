...
class Hello_moveit : public rclcpp::Node, public std::enable_shared_from_this<Hello_moveit>
{
public:
    Hello_moveit()
        : Node("hello_moveit")
    {
        ...
        auto move_group_interface = MoveGroupInterface(node_shared_ptr, "panda_arm");
